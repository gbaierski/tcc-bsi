    ...
    <main>
        ...
        <div id="objectives-items">
            ...
            <div class="objective-info">
                ...
                <div class="objective-additional rem"><b>Sem tomate</b></div>
            </div>
            </div>
        ...
        <RouterLink to="l1" @click="scrollToTop" style="margin: 30px 0px 50px 0px;"><button id="start-button">INICIAR</button></RouterLink>
    </main>
</template>
